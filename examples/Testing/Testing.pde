...
void setup() {
  ...
  // pgr = createGraphics(1920, 1080, P3D);
  ...
  spout.enableSpoutLogFile("C:/PROCESSING_SKETCHBOOKS/temp/Spout Processing Sender.log", true);
  //
  ...
  // spout.createSender("Spout Processing Sender");
...
void draw()  { 
  ...
  /*
    ...
    // The sender is updated if the window is resized
    spout.sendTexture();
    */
