...
//
//      For details, source code, FreeframeGL plugin
//      and more, install SpoutControls :
//
...
//
// RH click to open the SpoutController application.
// RH click again to hide/show the controller
// The controller is closed when the sketch
// is stopped or closed
// The controller is not necessary if you are using
// the SpoutController Freeframe plugin.
//
void mousePressed() {
